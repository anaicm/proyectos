...
using loginUsuarios.entidades;//todo lo que hay en la carpeta entidades ya puedo usarlo en esta clase como 'Role' y 'Usuario'
...
// hay usarla para que la clase sepa donde está "using loginUsuarios.entidades;"
...
//podria se int, etc.
public class UsuarioContext : IdentityDbContext<Usuario, Role, Guid>
{
    //constructor de "UsuarioContext", siempre es igual solo cambia el nombre de la clase 
